...
//               {/* ==================================================
//                   MOBILE PROFILE + THREE-DOT MENU
//               ================================================== */}

//               <div className="md:hidden flex items-center gap-1 ml-1">

//                 {/* ==================================================
//                     SEPARATE PROFILE ICON
//                 ================================================== */}

//                 <button
//                   type="button"
//                   onClick={handleMobileProfileClick}
//                   className="p-1.5 rounded-lg hover:bg-[#e9ddc8]/10 transition-colors flex items-center justify-center"
//                   aria-label="Profile"
//                   title="Profile"
//                 >
//                   <div className="w-8 h-8 bg-[#e9ddc8] rounded-full flex items-center justify-center border border-[#e9ddc8]/40 shadow-sm">
//                     <UserCheck className="w-4 h-4 text-[#502d13]" />
//                   </div>
//                 </button>
...
//                     setShowNotifications(false);
//                   }}
//                   className="p-2 rounded-lg hover:bg-[#e9ddc8]/10 transition-colors flex items-center justify-center"
//                   aria-label={
//                     isOpen
//                       ? "Close menu"
//                       : "Open menu"
...
//                   ) : (
//                     <MoreVertical className="w-6 h-6 text-[#e9ddc8]" />
//                   )}
//                 </button>
